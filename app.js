...
const TRANSLATIONS = {
  am: {
    ...
    nav_men: "Տղամարդկանց",
    nav_women: "Կանանց",
    nav_new: "Նոր Օծանելիքներ",
    nav_bestsellers: "Լավագույն Վաճառք",
    ...
    hero_title: "Նիշային օծանելիքի տունը <span class='hero-highlight'>Երևանում</span>",
    hero_desc: "Բարձրակարգ բույրեր, հիշվող նվերներ և գեղեցիկ փաթեթավորում — ամենն Հայաստանում։",
    ...
    featured_title: "Բոլոր Օծանելիքները",
    ...
    contact_address_label: "Իրավաբանական Հասցե",
    contact_address_value: "Արարատի մարզ, ք. Վեդի, Պուշկինի փողոց 34",
    ...
    footer_address: "Արարատի մարզ, ք. Վեդի, Պուշկինի փողոց 34",
    footer_authenticity_guarantee: "100% Օրիգինալ Խորշային Օծանելիքների Երաշխիք",
    policy_shipping_header_title: "ԱՌԱՔՈՒՄ",
    policy_shipping_subtitle: "ԱՋԱԿՑՈՒԹՅՈՒՆ",
    policy_shipping_title: "Առաքման, Չեղարկման և Վերադարձի Պայմաններ",
    ...
    policy_shipping_sec2_title: "2. Պատվերի Չեղարկում, Վերադարձ և Փոխանակում",
    policy_shipping_sec2_cancellation: "<strong>Պատվերի չեղարկում:</strong> Դուք կարող եք անվճար չեղարկել ձեր պատվերը ցանկացած պահի՝ նախքան այն առաքման հանձնելը: Չեղարկման համար խնդրում ենք անմիջապես կապվել մեզ հետ novagiftshoparmenia@gmail.com հասցեով կամ +374 98 019 250 հեռախոսահամարով:",
    ...
    policy_privacy_sec4_title: "4. Օրիգինալության Երաշխիք",
    policy_privacy_sec4_desc: "NOVA-ում վաճառվող բոլոր օծանելիքները 100% օրիգինալ են, ձեռք են բերվում բացառապես պաշտոնական արտադրողներից և սերտիֆիկացված ներկայացուցիչներից։ Մենք երաշխավորում ենք յուրաքանչյուր ապրանքի իսկությունը:",
    ...
    home_video_title: "Օծանելիքի Արվեստը",
    home_video_paragraph: "Մենք ընտրում ենք միայն լավագույնը։ Մեր հավաքածուի յուրաքանչյուր բույր ընտրվում է իր խորության, կերպարի և երկարատևության համար։",
  ...
  ru: {
    ...
    nav_men: "Мужчинам",
    nav_women: "Женщинам",
    nav_new: "Новые ароматы",
    nav_bestsellers: "Хиты продаж",
    ...
    maison_de_parfum: "Maison de Parfum",
    hero_title: "Ереванский дом нишевой <span class='hero-highlight'>парфюмерии</span>",
    hero_desc: "Премиальные ароматы, запоминающиеся подарки и красивая упаковка — всё в Армении.",
    ...
    contact_address_value: "Араратская область, г. Веди, ул. Пушкина 34",
    ...
    footer_address: "Араратская область, г. Веди, ул. Пушкина 34",
    footer_authenticity_guarantee: "100% Гарантия Оригинальности Нишевой Парфюмерии",
    policy_shipping_header_title: "ДОСТАВКА",
    policy_shipping_subtitle: "ПОДДЕРЖКА КЛИЕНТОВ",
    policy_shipping_title: "Правила доставки, отмены и возврата",
    ...
    policy_shipping_sec2_title: "2. Отмена заказа, Возврат и Обмен",
    policy_shipping_sec2_cancellation: "<strong>Отмена заказа:</strong> Вы можете бесплатно отменить свой заказ в любое время до его отправки. Для отмены заказа, пожалуйста, свяжитесь с нами по адресу novagiftshoparmenia@gmail.com или по телефону +374 98 019 250.",
    ...
    policy_privacy_sec4_title: "4. Гарантия Подлинности",
    policy_privacy_sec4_desc: "Вся парфюмерия, представленная в NOVA, является 100% оригинальной и поставляется исключительно от официальных производителей и сертифицированных дистрибьюторов. Мы гарантируем подлинность каждого флакона.",
    ...
    home_video_title: "Искусство парфюмерии",
    home_video_paragraph: "Мы выбираем только лучшее. Каждый аромат в нашей коллекции отобран за глубину, характер и стойкость.",
  ...
  en: {
    ...
    nav_men: "Men",
    nav_women: "Women",
    nav_new: "New Fragrances",
    nav_bestsellers: "Best-Selling Perfumes",
    ...
    maison_de_parfum: "Maison de Parfum",
    hero_title: "Yerevan's Home for <span class='hero-highlight'>Niche Fragrance</span>",
    hero_desc: "Premium fragrances, memorable gifts & beautiful packaging — all in Armenia.",
    ...
    featured_title: "Shop All Fragrances",
    ...
    contact_address_label: "Legal Address",
    contact_address_value: "34 Pushkin St., Vedi, Ararat Region, Armenia",
    ...
    footer_address: "34 Pushkin St., Vedi, Ararat Region, Armenia",
    footer_authenticity_guarantee: "100% Guaranteed Original Niche Perfumes",
    policy_shipping_header_title: "SHIPPING",
    policy_shipping_subtitle: "CUSTOMER SUPPORT",
    policy_shipping_title: "Shipping, Cancellation & Returns Policy",
    ...
    policy_shipping_sec2_title: "2. Order Cancellation, Return & Exchange Policy",
    policy_shipping_sec2_cancellation: "<strong>Order Cancellation:</strong> You can cancel your order free of charge at any time before it is dispatched for delivery. To cancel an order, please contact us immediately at novagiftshoparmenia@gmail.com or +374 98 019 250.",
    ...
    policy_privacy_sec4_title: "4. Authenticity Guarantee",
    policy_privacy_sec4_desc: "All fragrances sold at NOVA are 100% authentic and sourced directly from official manufacturers and certified distributors. We guarantee the origin and purity of every product in our collection.",
    ...
    home_video_title: "The Art of Perfumery",
    home_video_paragraph: "We source only the finest. Every scent in our collection is chosen for its depth, character, and staying power.",
