...
const TRANSLATIONS = {
  am: {
    ...
    about_story_title: "Մեր <span style='color: var(--color-brown)'>Սկիզբը</span>",
    ...
    contact_subtitle: "Եկեք <span style='color: var(--color-brown)'>զրուցենք</span>",
  ...
  ru: {
    ...
    about_story_title: "Наше <span style='color: var(--color-brown)'>Начало</span>",
    ...
    contact_subtitle: "Давайте <span style='color: var(--color-brown)'>Поговорим</span>",
  ...
  en: {
    ...
    about_story_title: "Our <span style='color: var(--color-brown)'>Beginning</span>",
    ...
    contact_subtitle: "Let's <span style='color: var(--color-brown)'>Talk</span>",
