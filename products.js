...
const GLOBAL_ATTRIBUTES = {
  ...
  concentrations: {
    edc: { id: "edc", label: { en: "Eau de Cologne (EdC)", am: "Օդեկոլոն (EdC)", ru: "Одеколон (EdC)" }, short: "EdC" },
    edt: { id: "edt", label: { en: "Eau de Toilette (EdT)", am: "Զուգարանի ջուր (EdT)", ru: "Туалетная вода (EdT)" }, short: "EdT" },
    edp: { id: "edp", label: { en: "Eau de Parfum (EdP)", am: "Պարֆյումերային ջուր (EdP)", ru: "Парфюмерная вода (EdP)" }, short: "EdP" },
    extrait: { id: "extrait", label: { en: "Extrait de Parfum", am: "Օծանելիքի էքստրակտ", ru: "Экстракт духов" }, short: "Extrait" }
  },
  genders: {
