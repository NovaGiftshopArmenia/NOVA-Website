    ...
    <div class="admin-table-wrap">
      <table class="admin-table text-left">
        ...
        <tbody id="admin-orders-tbody">
          <!-- Populated by WooCommerceAdmin.renderOrdersTable() -->
        </tbody>
      </table>
    </div>
  </div>
...
<div id="admin-sec-inventory" class="admin-panel-sub hidden">
  ...
  <div id="inv-sub-products" class="inv-sub-panel">
    <div class="admin-card">
      <!-- Header: title + Add New Product button + Import CSV -->
      <div>
      ...
      <table class="admin-table text-left">
        ...
        <tbody id="admin-inventory-tbody">
          <!-- Populated by WooCommerceAdmin.renderInventoryTable() -->
        </tbody>
      </table>
    </div>
  </div>
  ...
  <div id="inv-sub-brands" class="inv-sub-panel" style="display:none;">
    <div class="admin-card">
      ...
      <div id="admin-brands-list"><!-- Grid of brand cards --></div>
    </div>
  </div>
  ...
  <div id="inv-sub-trash" class="inv-sub-panel" style="display:none;">
    <div class="admin-card">
      ...
      <div id="admin-trash-list"><!-- Deleted items --></div>
...
<div id="admin-sec-developer" class="admin-panel-sub hidden">
  <div class="admin-card">
    ...
    <div class="admin-subcard">
      ...
      <div id="admin-access-list"><!-- Admin emails list --></div>
    </div>
  </div>
</div>
```
  ...
  <div class="pe-content">
    <div class="pe-main">
      ...
      <div class="pe-metabox">
        ...
        <!-- Jewelry Details Tab (replaces Fragrance Notes) -->
    ...
    <div class="pe-sidebar">
      <!-- Product Image metabox (upload + URL + gallery) -->
      <!-- Classification metabox (Category, Stone, Material) -->
      <!-- Tags metabox (Handmade, One-of-a-Kind, Gift, etc.) -->
      <!-- Product Stats metabox (Rating, Reviews, Featured) -->
    </div>
  </div>
</div>
```
...
// Usage:
const confirmed = await novaConfirm('Delete this product?');
