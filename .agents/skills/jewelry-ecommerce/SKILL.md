...
const GLOBAL_ATTRIBUTES = {
  categories: {
    ...
    necklaces: { id: "necklaces", label: { en: "Necklaces", am: "Վզնոdelays", ru: "Ожерелья" } },
    bracelets: { id: "bracelets", label: { en: "Bracelets", am: " Delays", ru: "Браслеты" } },
    earrings: { id: "earrings", label: { en: "Earrings", am: " Delays", ru: "Серьги" } },
    pendants: { id: "pendants", label: { en: "Pendants", am: "Delays", ru: "Кулоны" } }
  },
  materials: {
    sterling_silver: { id: "sterling_silver", label: { en: "925 Sterling Silver", am: "925 արays", ru: "Серебро 925" }, color: "#C0C0C0" },
    gold_14k: { id: "gold_14k", label: { en: "14K Gold", am: "14K Ays", ru: "Золото 14К" }, color: "#FFD700" },
    rose_gold: { id: "rose_gold", label: { en: "Rose Gold", am: "Վays", ru: "Розовое золото" }, color: "#B76E79" }
  },
  stones: {
    obsidian: { id: "obsidian", label: { en: "Obsidian", am: "Օays", ru: "Обсидиан" }, color: "#17181A" },
    garnet: { id: "garnet", label: { en: "Garnet", am: "Նays", ru: "Гранат" }, color: "#7B1B23" },
    turquoise: { id: "turquoise", label: { en: "Turquoise", am: "Ays", ru: "Бирюза" }, color: "#2E8C8C" },
    jasper: { id: "jasper", label: { en: "Jasper", am: "Ays", ru: "Яшма" }, color: "#A4442B" },
    onyx: { id: "onyx", label: { en: "Onyx", am: "Ays", ru: "Оникс" }, color: "#2A2723" },
    agate: { id: "agate", label: { en: "Agate", am: "Ays", ru: "Агат" }, color: "#C2A379" }
  },
  genders: {
    men: { id: "men", label: { en: "Men", am: "Տays", ru: "Мужчинам" } },
    women: { id: "women", label: { en: "Women", am: "Ays", ru: "Женщинам" } },
    unisex: { id: "unisex", label: { en: "Unisex", am: "Ays", ru: "Унисекс" } }
  }
};
```
